function [scenario, egoVehicle, egoWaypoints, actorWaypoints, allStatus, roadConfigs] = ds6_lanes_roadWith5Cars_egoTurningLeft()
...
car3 = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [31.500353038991 1.39144962374758 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car3');
waypoints = [31.500353038991 1.39144962374758 0;
    20.1 1.3 0;
    8.8 -0.7 0;
    0.4 -9.2 0;
    -1.6 -25.2 0;
